            ...
            <div class="row">
                <div class="col g-0">
                    <div class="container">
                        ...
                        <h2 class="text-dark text-center">Editar Produto</h2>
                        <hr>
                        ...
                        @method('PUT')
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" id="exampleFormControlInput1" value="{{$products->name}}" placeholder="Digite o nome do produto">
                                </div>
                                <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Descrição do produto</label>
                                <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="5">{{$products->description}}</textarea>
                                <br><br>
